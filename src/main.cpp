...
#if defined(NDEBUG)
# error "Sansicoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xa9506d3d159b45a055d4941ecf9e0ce4654f5c06a34886ad153994fcd5d80314");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Sansicoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Sansicoin Signed Message:\n";
...
{
    // Sansicoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 672000 blocks
    nSubsidy >>= (nHeight / 672000);
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Sansicoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Sansicoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6376f810fb274812a9935d3b7a3f5726d0f50c4596db2cb5b5bf57d5a2c4d7ac");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1449518644, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "India beat South Africa BY 200 runs";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04fe03dabfad917db58515c50650de1f1e4630f44fcc87c465f77c63e8af158e8bd3576df62fa27589504005d1b37272653b9bf303b9741e017b5b6796dba7cc43") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1461976806;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2897129;

        if (fTestNet)
        {
            block.nTime    = 1461930755;
            block.nNonce   = 2529567;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x708622f4242c011d8dc4e87d7ae66b73c79e6bec8650bdc5c74171030218b73f"));
...
unsigned char pchMessageStart[4] = { 0xa9, 0xd3, 0xc9, 0x0e }; // Sansicoin: increase each by adding 2 to bitcoin's value.
