#############################################################################
# Makefile for building: sansicoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Feb 22 20:00:09 2016
# Project:  Sansicoin.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake UPNP=- -o Makefile Sansicoin.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /tmp/sansicoin-source/src/leveldb/libleveldb.a /tmp/sansicoin-source/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: Sansicoin.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) UPNP=- -o Makefile Sansicoin.pro
...
/tmp/sansicoin-source/src/leveldb/libleveldb.a: FORCE
	cd /tmp/sansicoin-source/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/tmp/sansicoin-source/build/build.h: FORCE
	cd /tmp/sansicoin-source; /bin/sh share/genbuild.sh /tmp/sansicoin-source/build/build.h
