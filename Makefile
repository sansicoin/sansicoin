#############################################################################
# Makefile for building: Sansicoin-Qt.app/Contents/MacOS/Sansicoin-Qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Apr 30 10:04:06 2016
# Project:  Sansibar.pro
# Template: app
# Command: /usr/local/bin/qmake USE_IPV6=1 USE_QRCODE=1 USE_UPNP=- RELEASE=1 -o Makefile Sansibar.pro
#############################################################################
...
CFLAGS        = -pipe -mmacosx-version-min=10.7 -mmacosx-version-min=10.9 -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -O2 -arch x86_64 -pthread -Wall -W $(DEFINES)
...
DIST          = /usr/local/Cellar/qt/4.8.7_2/mkspecs/common/unix.conf \
		...
		Sansibar.pro
QMAKE_TARGET  = Sansicoin-Qt
DESTDIR       = 
TARGET        = Sansicoin-Qt.app/Contents/MacOS/Sansicoin-Qt
...
all: Makefile Sansicoin-Qt.app/Contents/PkgInfo Sansicoin-Qt.app/Contents/Resources/empty.lproj Sansicoin-Qt.app/Contents/Info.plist Sansicoin-Qt.app/Contents/Resources/sansicoin.icns $(TARGET)

$(TARGET): /Users/pm/github/sansicoin/src/leveldb/libleveldb.a /Users/pm/github/sansicoin/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_qrcodedialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) Sansicoin-Qt.app/Contents/MacOS/ || $(MKDIR) Sansicoin-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Sansibar.pro  /usr/local/Cellar/qt/4.8.7_2/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.7_2/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/clang.conf \
	...
	$(QMAKE) USE_IPV6=1 USE_QRCODE=1 USE_UPNP=- RELEASE=1 -o Makefile Sansibar.pro
...
distclean: clean
	-$(DEL_FILE) -r Sansicoin-Qt.app
	-$(DEL_FILE) Makefile


/Users/pm/github/sansicoin/src/leveldb/libleveldb.a: FORCE
	cd /Users/pm/github/sansicoin/src/leveldb && CC=clang CXX=clang++ $(MAKE) OPT="-pipe -stdlib=libc++ -mmacosx-version-min=10.7 -mmacosx-version-min=10.9 -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/Users/pm/github/sansicoin/build/build.h: FORCE
	cd /Users/pm/github/sansicoin; /bin/sh share/genbuild.sh /Users/pm/github/sansicoin/build/build.h
