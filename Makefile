...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun May 1 13:02:26 2016
# Project:  Sansibar.pro
# Template: app
# Command: /usr/local/bin/qmake USE_UPNP=- USE_IPV6=1 USE_QRCODE=1 -o Makefile Sansibar.pro
#############################################################################
...
Makefile: Sansibar.pro  /usr/local/Cellar/qt/4.8.7_2/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.7_2/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- USE_IPV6=1 USE_QRCODE=1 -o Makefile Sansibar.pro
...
/Users/pm/github/sansicoin/src/leveldb/libleveldb.a: FORCE
	cd /Users/pm/github/sansicoin/src/leveldb && CC=clang CXX=clang++ $(MAKE) OPT="-pipe -stdlib=libc++ -mmacosx-version-min=10.7 -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/logo-sansi.png \
